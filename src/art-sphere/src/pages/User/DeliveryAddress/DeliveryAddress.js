  ...
  return (
    <div className="user-delivery-address-wrap">
        ...
        <form className="delivery-address-form">
          ...
          <label className='text-primary m-3'>
            Kod pocztowy
            <input className={`form-control loginForm ${postcodeErrors ? "is-invalid" : ""}`} value={postcode} onChange={(e) => setPostcode(e.target.value)} type="text" placeholder="Kod pocztowy"/>
